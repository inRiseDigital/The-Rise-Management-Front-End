...
//         "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkRldiBVc2VyIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";

//     String username = _emailController.text.trim();
//     if (username.isEmpty) {
//       username = "dev_user"; // Default username if empty
//     }

//     // Check if user entered "admin" in username to grant admin role
//     if (username.toLowerCase().contains("admin")) {
//       Navigator.of(context).pushReplacement(
//         MaterialPageRoute(
//           builder: (context) => ChatScreen(accessToken: fakeToken),
//         ),
//       );
//     } else {
//       Navigator.of(context).pushReplacement(
...
//           builder:
//               (context) =>
//                   DashboardOverview(username: username, accessToken: fakeToken),
//         ),
//       );
//     }
//   }
